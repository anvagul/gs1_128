...
class SectionBuilder
{
    ...
    private $data = [
        ...
        '20' => [2, 2, 'INTERNAL PRODUCT VARIANT - must contains exact 2 digits'], 
        ...
        '93' => [1, 30, 'Company internal information'],
        '240' => [1, 15, 'ADDITIONAL PRODUCT IDENTIFICATION ASSIGNED BY THE MANUFACTURER (240) - must contains between 1-15 digits'],
        '3300' => [6, 6, 'CONTAINER GROSS WEIGHT (KG) - must contains 6 chars, without decimal places'],
